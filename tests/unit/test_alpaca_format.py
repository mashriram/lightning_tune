...
def test_alpaca_format_loading(tmp_path):
    ...
    assert config.data.instruction_column == "instruction"
    assert config.data.input_column == "input"
    assert config.data.output_column == "output"
